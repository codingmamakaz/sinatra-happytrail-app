...
panhandle = Trail.create(name:  "Pan handle", length: 1.5, bathroom: false, cell_reception: true, user_id: kazumi.id)	
frick = Trail.create(name:  "Frick", length: 1, bathroom: true, cell_reception: true, user_id: kazumi.id)
scrubgrass = Trail.create(name:  "Scrubgrass", length: 1.7, bathroom: false, cell_reception: true, user_id: john.id)
